...
| --- | --- | --- |
| `eval_batch_fail_count` | — | Simple batch pass/fail count (legacy, unused) |
...
| `eval_point_mismatch_mask` | `runCairoPointMismatchDetail` | Single-point 8-bit mismatch bitmask |
| `eval_point_mismatch_mask_and_actual` | — | Mask + actual signs (9-tuple) |
...
```
JS eval script
  → constructs [engine_id, point_data, expected_signs] as JSON
